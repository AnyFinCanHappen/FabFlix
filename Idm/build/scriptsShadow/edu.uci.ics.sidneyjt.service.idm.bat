...
set CLASSPATH=%APP_HOME%\lib\edu.uci.ics.sidneyjt.service.idm.jar

@rem Execute edu.uci.ics.sidneyjt.service.idm
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EDU_UCI_ICS_SIDNEYJT_SERVICE_IDM_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
